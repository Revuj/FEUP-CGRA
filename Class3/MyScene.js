...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'Wooden Style': 4 };
    }
    display() {
